...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../project.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../project.gen/sources_1/ip/vio_1/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../project.gen/sources_1/ip/vio_1/hdl" \
